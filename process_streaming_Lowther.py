...
Create a stream of data using a CSV from Kaggle

This CSV contains data about real estate prices
...
INPUT_FILE_NAME = "real_estate_prices.csv"
...
def prepare_message_from_row(row):
    ...
    Serial_Number, List_Year, Date_Recorded, Town, Address, Assessed_Value, Sale_Amount, Sales_Ratio, Property_Type, Residential_Type, Non_Use_Code, Assessor_Remarks, OPM_remarks, Location = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{Serial_Number}, {List_Year}, {Date_Recorded}, {Town}, {Address}, {Assessed_Value}, {Sale_Amount}, {Sales_Ratio}, {Property_Type}, {Residential_Type}, {Non_Use_Code}, {Assessor_Remarks}, {OPM_remarks}, {Location}]"
